        ...
        >
          <div className='cursor-default flex flex-col justify-center align-middle items-left max-w-2xs gap-1 mr-10'>
            ...
            <p className='text-xs text-neutral-400'>
              Soy un estudiante de ingeniería informática con muchas ganas de desarrollar proyectos interesantes que me
              permitan seguir aprendiendo cada día.
            </p>
            <p className='text-xs text-neutral-400'>
            ...
            <div className='text-xl pt-2 flex gap-2 items-center'>
              ...
              {isOpenEmail && (
                ...
                >
                  jlopep09@estudiantes.unileon.es
                </motion.p>
              )}
            </div>
          </div>
